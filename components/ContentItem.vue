<template>
    <div  class="rounded-2xl mb-6 shadow w-full bg-gray-50 text-black dark:bg-gray-900 dark:text-white p-6 flex flex-col items-center gap-3">
        <div class="flex flex-row items-center w-full gap-4">
            <div v-if="item.cover && item.coverPosition === 'left'">
                <img :src="item.cover" class="rounded-2xl w-28 " />
            </div>
